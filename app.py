...
GENRE_COLORS = ["#e94560","#f97316","#a855f7","#3b82f6","#10b981","#f59e0b","#ec4899","#06b6d4"]
...
.hero-badge {
    ...
    color: #fff; font-size: .68rem; font-weight: 700; letter-spacing: .2em;
    text-transform: uppercase; padding: .35rem 1.1rem; border-radius: 100px;
    margin-bottom: 1.1rem; font-family: 'Space Mono', monospace;
}
.hero-title {
    font-size: clamp(2.8rem,6vw,4.8rem); font-weight: 800; line-height: 1.05;
    background: linear-gradient(135deg, #ffffff 20%, #e94560 90%);
...
.stat-pill {
    ...
    font-size: .82rem; color: #666688; display: flex; align-items: center; gap: .4rem;
}
.stat-pill strong { color: #c8c8e0; }

/* SELECT */
div[data-baseweb="select"] > div {
    background: #0f0f20 !important; border: 1.5px solid #1e1e38 !important;
    border-radius: 14px !important; font-size: 1rem !important; color: #e8e8f0 !important;
    transition: border-color .25s !important;
}
div[data-baseweb="select"] > div:hover,
div[data-baseweb="select"] > div:focus-within {
    border-color: #e94560 !important; box-shadow: 0 0 0 3px rgba(233,69,96,.12) !important;
}
[data-baseweb="menu"] { background: #0f0f20 !important; border: 1px solid #1e1e38 !important; border-radius: 12px !important; }
[role="option"] { color: #e8e8f0 !important; }
[role="option"]:hover { background: #1a1a30 !important; }
...
.stButton > button {
    ...
    font-family: 'Outfit', sans-serif !important; width: 100%;
}
.stButton > button:hover { transform: translateY(-2px) !important; box-shadow: 0 8px 28px rgba(233,69,96,.38) !important; }

/* SELECTED BANNER */
.selected-banner {
    background: linear-gradient(135deg,#0f0f20,#18182e);
    border: 1.5px solid #e94560; border-radius: 18px;
...
.card-title {
    ...
    color: #e8e8f0; line-height: 1.35;
    margin-bottom: 1.1rem; min-height: 2.7rem;
}
...
<div class="hero">
  ...
  <p class="hero-sub">4,800+ films · cosine similarity · instant results</p>
  <hr class="glow-line">
</div>
""", unsafe_allow_html=True)
...
<div class="stats-row">
  ...
  <div class="stat-pill">🧠 <strong>Cosine Similarity</strong></div>
  <div class="stat-pill">⚡ <strong>Instant</strong>&nbsp;results</div>
...
st.markdown("""
<div class="footer">
  Built with ❤️ &nbsp;·&nbsp; <strong>CineAI</strong> &nbsp;·&nbsp; Streamlit &nbsp;·&nbsp; Cosine Similarity on 4,800 movies<br>
